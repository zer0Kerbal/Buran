...
[![Buran][MOD:shd:latest]][MOD:forum] [![KSP version][KSP:shd]][KSP:url]  [![License][LIC:shd]][LIC:url]  
...
# Buran Space Station (BURN)

The Soviet Space Station Buran for Kerbal Space Program.

## By [`zer0Kerbal`][zer0Kerbal] and [Sampa][sampa], originally by [BobCat][bobcat], [`DECQ`][decq] and [Dragon01][dragon01]

adopted with *express* permission and brought to you by *KerbSimpleCo*

<img src="https://raw.githubusercontent.com/zer0Kerbal/Buran/master/img/HeroLogo_1920x1920.png" alt="Buran Hero" width="50%" height="50%">

### Features by [BobCat][bobcat]

* Modular space station
  * Buran Core module with living quarters, six docking ports and a detailed IVA.
  ...
  * Zvezda service module (Buran Core variant) with 4 docking ports.
  * New solar panels and an ISS-style docking port.

### Preamble by [Wikipedia](https://en.wikipedia.org/wiki/Buran)

> ***Buran*** ([Russian](https://en.wikipedia.org/wiki/Russian_language): Мир, IPA: [[ˈmʲir\]](https://en.wikipedia.org/wiki/Help:IPA/Russian); lit. 'peace' or 'world') was a [space station](https://en.wikipedia.org/wiki/Space_station) that operated in [low Earth orbit](https://en.wikipedia.org/wiki/Low_Earth_orbit) from 1986 to 2001, operated by the [Soviet Union](https://en.wikipedia.org/wiki/Soviet_Union) and later by [Russia](https://en.wikipedia.org/wiki/Russia). *Buran* was the first modular space station and was assembled in orbit from 1986 to 1996. It had a greater mass than any previous [spacecraft](https://en.wikipedia.org/wiki/Spacecraft). At the time it was the largest [artificial satellite](https://en.wikipedia.org/wiki/Artificial_satellite) in orbit, succeeded by the [International Space Station](https://en.wikipedia.org/wiki/International_Space_Station) (ISS) after *Buran*'s [orbit decayed](https://en.wikipedia.org/wiki/Orbital_decay).
...
>
> [DECQ Link](https://forum.kerbalspaceprogram.com/index.php?/topic/79479-energia-project-v15a-Buran-v4/&do=findComment&comment=3802379) "Do what you want with him."
>
> [DECQ Link](https://forum.kerbalspaceprogram.com/index.php?/topic/79479-energia-project-v15a-Buran-v4/&do=findComment&comment=3939818) "It's okay if you have the urge to accept this and publish, you are free to do so."
...
>
> [BobCat Link](https://forum.kerbalspaceprogram.com/index.php?/topic/79479-energia-project-v15a-Buran-v4/&do=findComment&comment=3939818) "It's okay if you have the urge to accept this and publish, you are free to do so."

<!-- mod links -->
[MOD:attr]: https://zer0kerbal.github.io/Buran/Attributions "Attribution"
[MOD:chlog]: https://raw.githubusercontent.com/zer0Kerbal/Buran/master/changelog.md  "Changelog"
[MOD:discu]: https://github.com/zer0Kerbal/Buran/discussions "Discussions"
[MOD:forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/209896-*/ "Buran Forum Thread"
[MOD:issue]: https://github.com/zer0Kerbal/Buran/issues "Issues"
[MOD:assmb]: https://zer0kerbal.github.io/Buran/Assembly "Assembly Guide"
[MOD:markt]: https://zer0kerbal.github.io/Buran/Marketing "Marketing Slicks"
[MOD:notic]: https://zer0kerbal.github.io/Buran/Notices "Notices"
[MOD:parts]: https://zer0kerbal.github.io/Buran/PartsCatalog "Parts Catalog"
[MOD:pages]: https://zer0kerbal.github.io/Buran "GitHub Pages"

<!--- mod -->
[MOD:shd:latest]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/Buran/master/json/mod.json

[MOD:pages:shd]: https://img.shields.io/badge/GitHub-Pages-white?style=plastic&labelColor=9cf&logoColor=181717&logo=github "GitHub IO"

<!--- mod provenance -->
[MOD:2:dnload]: https://www.curseforge.com/kerbal/ksp-mods/Buran "CurseForge"
[MOD:2:source]: https://github.com/zer0Kerbal/Buran/ "GitHub"
...
[LIC:shd]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/Buran/master/json/license.json "CC BY-ND 4.0"

<!--- CKAN -->
[ckan:img]: https://i.postimg.cc/x8XSVg4R/sj507JC.png "CKAN"
[ckan:url]: http://forum.kerbalspaceprogram.com/index.php?/topic/197082-*/ "CKAN"
[ckan:shd]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/zer0Kerbal/Buran/master/json/ckan.json "CKAN"

<!--- release links -->
[CURSFG:url]: https://www.curseforge.com/kerbal/ksp-mods/Buran "Curseforge"
[CURSFG:shd]: https://img.shields.io/badge/CurseForge-Link-CCFF00.svg?labelColor=6441A4&style=plastic&logo=curseforge "Curseforge"

[GITHUB:url]: https://github.com/zer0Kerbal/Buran/ "GitHub"
...
[Buran]: https://forum.kerbalspaceprogram.com/index.php?/topic/204186-*/ "Buran"
...
* [issues][MOD:issue]
* [projects](https://github.com/zer0Kerbal/Buran/projects/)
* [releases](https://github.com/zer0Kerbal/Buran/releases/)
